<template>
    <div v-show="!route.meta.showfater">
        <ul>
            <li @click='todetail' v-for="(item,index) in ( isMobile ? activeList() : showList)" :key="index">
                <div class="image">
        ...
        <div class="page" v-if="isMobile">
            ...
            <span @click="prev" disabled='true'>上一页</span>
            <!-- <span>{{currentPage}}</span> -->
            <span @click="topage(i)" :class="[i == currentPage ? 'cur' : '']" v-for="(i, index) in totalPages" :key="index">{{i}}</span>
...
console.log(route.meta.showfater)
...
const showList = ref([
    {title:'xxx防撞车', imgUrl:'https://pic.imgdb.cn/item/654d835ac458853aef9f4520.png'},
    {title:'xxx防撞车', imgUrl:'https://pic.imgdb.cn/item/654d835ac458853aef9f4520.png'},
    {title:'xxx防撞车', imgUrl:'https://pic.imgdb.cn/item/654d835ac458853aef9f4520.png'},
    {title:'xxx防撞车', imgUrl:'https://pic.imgdb.cn/item/654d835ac458853aef9f4520.png'},
    {title:'xxx防撞车', imgUrl:'https://pic.imgdb.cn/item/654d835ac458853aef9f4520.png'},
